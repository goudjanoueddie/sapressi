...
folder are mapped to the application's root namespace, 'Jdeveloper'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Jdeveloper"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Jdeveloper' in the same way
as `"Jdeveloper/sass/src"`.
